! function (t) {
	...
	var o, r = !!("ontouchstart" in window),
	...
	c.distance = function (t, e) {
		...
		if (t.length)
			for (var i = 0, n = t.length; i < n; i += 1) e(t[i]);
		else e(t)
		...
		if ((e = i.idles.indexOf(d)) >= 0 && i.idles.splice(e, 1), i.actives.push(d), i.ids.push(d.identifier), "semi" !== n.mode) a(d);
		else {
