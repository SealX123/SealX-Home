...
function showHelp() {
	...
	$("#inst_main_body").html("<div id = 'instructions_head'>怎么玩</div><p>阻止方块离开外层灰色六边形的内部</p><p>" + (settings.platform != 'mobile' ? '点击左右方向键' : '轻敲屏幕的左右两侧') + "来旋转六边形。" + (settings.platform != 'mobile' ? '点击向下箭头键加速方块下落': '') + " </p><p>通过使3个及以上相同颜色的方块接触来消除方块并获得点数。</p><p>你的连击消失前所剩时间由外部<span style='color:#f1c40f;'>六边形</span>上的<span style='color:#e74c3c'>彩色</span> <span style='color:#3498db'>线条</span>来<span style='color:#2ecc71'>显示</span></p>");
	if (gameState == 1) {
		pause();
	}
