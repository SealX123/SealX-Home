...
var time = d.getHours();
if (time < 24) {
	document.getElementById("title").innerHTML = "AFCNAV | Good evening";
}
if (time < 18) {
	document.getElementById("title").innerHTML = "AFCNAV | Good afternoon";
}
if (time < 12) {
	document.getElementById("title").innerHTML = "AFCNAV | Good morning";
}
if (time < 5) {
	document.getElementById("title").innerHTML = "AFCNAV | Stay up late again";
}
//title问候语结束
